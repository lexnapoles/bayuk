...
export default router => {
	...
	router.put("/products/:productId", auth, verifyUser, verifyProduct, jsonParser, updateOneProduct);

	router.delete("/products/:productId", auth, verifyUser, verifyProduct, deleteOneProduct);
