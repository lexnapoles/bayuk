...
const hasNeededKeys = action =>
  action.request && action.success && action.failure;

const isEveryKeyAString = action =>
  Object.keys(action).every(t => typeof action[t] === "string");
...
export const FETCH_PRODUCTS_ON_SELL = asyncActionTypes(
